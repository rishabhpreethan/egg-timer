    ...
    >
      <Link to={`/timer/${eggData.id}`} className="block">
        <div className="flex items-center gap-6">
          <div className="w-16 h-16 flex items-center justify-center bg-orange-100 rounded-lg">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2">
              <div className="bg-orange-100 px-3 py-1 rounded-lg text-sm font-medium text-orange-900">
